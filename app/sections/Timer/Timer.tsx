...
function Timer() {
  ...
  return (
    <section className='timer-section flex justify-center' id="about-wehack">
      <div className="timer-group pt-10 md:-mt-20 md:pb-32">
      <div className="countdown">
            ...
            <div className="wehack-mascot">
              <img 
                className="wehack-stats-mascot h-auto w-[7rem] sm:w-[10rem] md:w-[12rem] lg:w-[14rem] scale-x-[-1] md:ml-10 lg:ml-14"  
